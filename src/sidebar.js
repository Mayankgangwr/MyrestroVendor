    ...
    <div className="position-sticky">
      <div className="list-group list-group-flush mt-4">
        ...
        <NavLink activeClassName="active" to="/order" className="list-group-item list-group-item-action side-item-p ripple">
            <img src="./images/order.png" width='17' className='sidebar-icon'/><span>Orders</span>
        </NavLink>
        <NavLink activeClassName="active" to="/categories" className="list-group-item list-group-item-action side-item-p ripple">
            <img src="./images/category.png" width='17' className='sidebar-icon'/><span>Categories</span>
        </NavLink>
        <NavLink activeClassName="active" to="/products" className="list-group-item list-group-item-action side-item-p ripple">
            <img src="./images/product.png" width='17' className='sidebar-icon'/><span>Products</span>
        </NavLink>
      </div>
    </div>
  </nav>
