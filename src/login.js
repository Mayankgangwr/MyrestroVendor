...
const Loginform = () =>{  
  ...
  const Login = (e) =>{
    e.preventDefault(); 
    axios.post("https://sattasafari.com/restro/login.php", data)
    ...
    <div class="row gx-lg-5 align-items-center mb-5">
      <div class="col-lg-7 mb-lg-5 mb-lg-0" style={{zIndex: '10'}}>
        <h1 class="my-5 display-5 fw-bold ls-tight" style={{color: 'hsl(218, 81%, 95%)'}}>
          India's first Free QR Ordring<br />
          <span style={{color: 'hsl(218, 81%, 75%)'}}>And POS Software</span>
        </h1>
         </div>
              ...
              <div class="row">
                ...
                <div class="col-12s mb-4">
                  <div class="form-outline">
                    <input type="text" name="userid" value={data.userid} onChange={handleChange} placeholder="Enter Username" class="form-control border border-dark" />
                  </div>
                </div>
                <div class="col-12s mb-4">
                  <div class="form-outline">
                    <input type="text" name="password" value={data.password} onChange={handleChange} placeholder="Enter Password" class="form-control border border-dark" />
                  </div>
                </div>
